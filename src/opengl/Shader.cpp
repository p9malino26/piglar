...
void Shader::uniformInt(const std::string& nameInShader, int x)
{
	//use();
...
void Shader::uniformMat4 (const std::string& nameInShader, const glm::mat4& mat)
{
	//use();
...
void Shader::uniformVec3(const std::string& nameInShader, const glm::vec3& vec)
{
	//use();
...
void Shader::uniformVec4(const std::string& nameInShader, const glm::vec4& vec)
{
	//use();
	int vec_loc = getUniformLoc(nameInShader);
	checkForUniformExistence(vec_loc, nameInShader);
