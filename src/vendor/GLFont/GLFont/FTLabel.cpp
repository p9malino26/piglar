...
FTLabel::FTLabel(shared_ptr<GLFont> ftFace, int windowWidth, int windowHeight, const std::string& shaderDir) :
  ...
  _height(0)
{
    ...
    GLUtils::loadShader(shaderDir + "/fontVertex.shader", GL_VERTEX_SHADER, _programId);
    GLUtils::loadShader(shaderDir + "/fontFragment.shader", GL_FRAGMENT_SHADER, _programId);
    ...
    unsigned int curTex = _fontAtlas[_pixelSize]->getTexId(); // get texture ID for this pixel size
...
FTLabel::FTLabel(GLFont* ftFace, int windowWidth, int windowHeight, const std::string& shaderDir) :
  FTLabel(std::shared_ptr<GLFont>(new GLFont(*ftFace)), windowWidth, windowHeight, shaderDir)
{}

FTLabel::FTLabel(shared_ptr<GLFont> ftFace, const char* text, float x, float y, int width, int height, int windowWidth, int windowHeight, const std::string& shaderDir) :
  FTLabel(ftFace, text, x, y, windowWidth, windowHeight, shaderDir)
{
    _width = width;
    _height = height;
...
FTLabel::FTLabel(shared_ptr<GLFont> ftFace, const char* text, float x, float y, int windowWidth, int windowHeight, const std::string& shaderDir) :
FTLabel(ftFace, windowWidth, windowHeight, shaderDir)
{
    _text = (char*)text;
    _x = x;
    _y = y;
