...
public:
    ...
    FTLabel(shared_ptr<GLFont> ftFace, int windowWidth, int windowHeight, const std::string& shaderDir);
    FTLabel(GLFont* ftFace, int windowWidth, int windowHeight, const std::string& shaderDir);
    FTLabel(shared_ptr<GLFont> ftFace, const char* text, float x, float y, int width, int height, int windowWidth, int windowHeight, const std::string& shaderDir);
    FTLabel(shared_ptr<GLFont> ftFace, const char* text, float x, float y, int windowWidth, int windowHeight, const std::string& shaderDir);
    ~FTLabel();
